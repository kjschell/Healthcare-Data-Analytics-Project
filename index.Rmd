...
Observations 317, 964, 973, 1221, and 1601 demonstrated significant influence. When I re-specify the model without the YearsAtCompany variable. I will remove these variables for the updated models. 

## Updated Dataset and Model {.tabset}

Based on the Assumption Diagnostic Testing, I decided to definitively remove YearsAtCompany. Additionally, I will hold out the overly influencial observations. Lastly, I will create two models, one with Age and one without Age. 

### New Models

```{r}
remove <- c(317, 964, 973, 1221, 1601)
...
There is little change in model performance with and without TotalWorkingYears. Given this, I will move ahead with diagnosti testing of assumptions for the newest model, reg7.
...
linearity.check.new <-train.att.No.Outlier %>%
  select(Age, DistanceFromHome, YearsInCurrentRole, YearsSinceLastPromotion)
predictors.new <- colnames(linearity.check.new)
