...
With regard to environmental satisfaction, the odds of Attrition are predicted to change by 0.26 times on average for those who respond with level 2 as compared to those who reply with level 1 when controlling for all other variables in the model. In other words, respondents with level 2 are predicted to have odds 74% lower than those with level 1. Interestingly, respondents with level 3 are predicted to have 70% higher odds on average. Level 4 has predicted odds 7% lower on average than seen with level 1.
...
Being married for single increase the odds of Attrition when compared to those who are single in this sample. More specifically, those who are married have odds of Attrition 1.62 times on average as compared to those who are divorced when controlling for all other variables in the model. In contrast, those who are single are predicted to have odds 9.19 times on average those who are divorced.  

Increasing response levels on the question of JobInvolvement change the odds differently when compared to the reference level 1. For example, those who rate their JobInvolement as a 2 have odds that are 0.11 on average times the odds of those with a 1 rating. Interestingly, those who have a rating of 3 have odds 1.19 times those with a 1 rating while those who rate their JobInvolvement as a 4 have odds 0.93 times those who rate it as a 1. Levels 2 and 4 are associated with reduced odds of leaving one's job, whereas, level 3 is associated with increased odds in this sample. 

Within this sample, higher levels of JobSatisfication resulted in lower odds of Attrition when compared to a level 1 rating. Levels 2, 3, and 4 had odds 0.44, 0.99, and 0.75 on average times the odds of level 1 when controlling for all other variables in the model.

Lastly, higher JobLevels demonstrated a similarly polarized impact on odds for Attrition as seen with JobInvolvement. Those who responded with a level 2 or 4 had odds 0.13 and 0.31 on average times those with level 1. In contrast, those with level 3 had odds 1.57 on average times those with level 1 when controlling for all other variables. 
...
We are 95% confident that for every one year increase in career length, the odds of leaving a job change by 0.81 times to 0.92 times, controlling for all other independent variables in the model. In other words, the odds of Attrition decrease on average between 8% and 9%.

Similarly, we are 95% confident that in our population of interest, for every one year increase in time spent in a current role changes, the odds of leaving a job change by 0.69 to 0.88. In other words, the odds decrease on average by 12% to 31% on average. 

In contrast, for every one year increase in time since the last promotion, the odds for attrition change by 1.05 times to 1.36 times. In order words, the odds increase between 5% and 36% on average for every one year increase and when controlling for all other variables in the model. 

With regard to the Environmental Satisfaction question, recording the second level changes the odds of leaving one's job by 0.14 times to 0.38 times when compared to those who record the lowest level on average. In other words, the odds of leaving a job decrease between 62% and 86%. Recording the third level relative to the lowest level is predicted to increase the odds of Attrition by 1.18 times to 3.10 times. Recording the highest level of environmental satisfaction changes the odds by 0.61 to 1.60 times. 

Working overtime strongly predicts Attrition as evidenced by an increase in odds between 17.19 to 55.44 times when controlling for all other variables.

In contrast, Marital Status does not appear to have a clear effect as the odds are predicted to change between 0.73 and 2.98 times.
