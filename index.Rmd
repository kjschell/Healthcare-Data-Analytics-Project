...
As referenced in the sample results, JobRole levels offer little value in understanding the change in odds. The 95% confidence intervals not only capture 1 but also range from 0 to infinity. In other words, respondents who are nurses have odds that range from 0 to infinity times the odds as compared to those who are administrators. We have no evidence that the different roles are associated with an increase or decrease in the odds of leaving one's job.

In contrast, the 95% confidence interval around the exponentiated coefficient for commuting distance does not capture 1. From the results it appears that for each one mile increase in distance from home the odds of Attrition increase from at least 1.05 to 1.11 times on average when controlling for all other variables in the model. In other words, the odds of Attrition increase on average between 5% and 11%. 
